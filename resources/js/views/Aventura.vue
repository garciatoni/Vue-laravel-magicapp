                ...
                <div class="space-y-2">
                    ...
                    <div class="bg-white bg-opacity-25 border border-blue-400 flex flex-col sm:flex-row items-center sm:items-start text-center">
                        ...
                        <div class="p-2 sm:w-9/12 flex flex-col items-center justify-center space-y-2">
                            ...
                            <a class="text-lg hover:text-red-800 focus:text-blue-500 focus:outline-none" target="_blanck" href="https://www.amazon.es/Miguel-De-Cervantes-Saavedra/e/B000APV3WE?ref_=dbs_p_pbk_r00_abau_000000">(Miguel De Cervantes Saavedra)</a>  
                    ...
                    <div class="bg-white bg-opacity-25 border border-blue-400 flex flex-col sm:flex-row items-center sm:items-start text-center">
                        ...
                        <div class="p-2 sm:w-9/12 flex flex-col items-center justify-center space-y-2">
                            ...
                            <a class="text-lg hover:text-red-800 focus:text-blue-500 focus:outline-none" target="_blanck" href="https://www.amazon.es/Jonathan-Swift/e/B001HCV1RG?ref_=dbs_p_pbk_r00_abau_000000">(Jonathan Swift)</a>  
                            <p class="text-justify flex items-center justify-center">
                    ...
                    <div class="bg-white bg-opacity-25 border border-blue-400 flex flex-col sm:flex-row items-center sm:items-start text-center">
                        ...
                        <div class="p-2 sm:w-9/12 flex flex-col items-center justify-center space-y-2">
                            ...
                            <a class="text-lg hover:text-red-800 focus:text-blue-500 focus:outline-none" target="_blanck" href="https://www.amazon.es/Julio-Verne/e/B00F1CW7NK?ref_=dbs_p_pbk_r00_abau_000000">(Julio Verne)</a>  
                            <p class="text-justify flex items-center justify-center">
                    ...
                    <div class="bg-white bg-opacity-25 border border-blue-400 flex flex-col sm:flex-row items-center sm:items-start text-center">
                        ...
                        <div class="p-2 sm:w-9/12 flex flex-col items-center justify-center space-y-2">
                            ...
                            <a class="text-lg hover:text-red-800 focus:text-blue-500 focus:outline-none" target="_blanck" href="https://www.amazon.es/Robert-Louis-Stevenson/e/B00JVVRCRS?ref_=dbs_p_pbk_r00_abau_000000">(Robert Louis Stevenson)</a>  
                            <p class="text-justify flex items-center justify-center">
